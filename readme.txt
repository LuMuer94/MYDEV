...
It contains a very minimal realm and URL configuration (in comments: settings to disable Shiro's session management,
since REST services should be stateless).

The configured WT2Realm is located in the business module. It extends the existing 'AuthorizingRealm' class of the Shiro
